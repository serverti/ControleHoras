 ...
 */
class getBancoHorasRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\BancoHorasRepository' shared autowired service.
     *
     * @return \App\Repository\BancoHorasRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'BancoHorasRepository.php';

        return $container->privates['App\\Repository\\BancoHorasRepository'] = new \App\Repository\BancoHorasRepository(($container->services['doctrine'] ?? self::getDoctrineService($container)));
    }
}
